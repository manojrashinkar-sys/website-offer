...
const K: Knowledge = {
  "faqs": [
    ...
    },
    {
      "id": "process-stages",
      "category": "Development Process",
      "question": "What are the stages of a project?",
      "answer": "Discovery, content and planning, design and development, review and testing, domain and launch, then handover and support. Each stage has agreed responsibilities so it is always clear who is doing what next.",
      "keywords": [
        "process",
        "stages",
        "phases",
